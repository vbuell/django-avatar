...
def render_primary(request, user=None, width=0, height=0):
    width = int(width)
    height = int(height)
    if width == 0 and height == 0:
        avatar = get_primary_avatar(user, width=settings.AVATAR_DEFAULT_SIZE, height=settings.AVATAR_DEFAULT_SIZE)
    else:
